odoo.define('oepetstore.CustomFormView', function (require) {
    "use strict";
    
    var BasicView = require('web.BasicView');
    var Context = require('web.Context');
    var core = require('web.core');
    var CustomFormController = require('oepetstore.CustomFormController');
    var CustomFormRenderer = require('oepetstore.CustomFormRenderer');
    const { generateID } = require('web.utils');
    
    var _lt = core._lt;
    
    var CustomFormView = BasicView.extend({
        ...
        init: function (viewInfo, params) {
            console.log("in form init function");
            alert("in form init function");
